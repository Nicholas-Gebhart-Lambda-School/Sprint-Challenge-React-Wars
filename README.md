...
- The React virtual DOM is fast, the regular DOM is slow. React handles how pages deal with data changing over time in a much less performance-efficient way.

- [ ] What does it mean to _think_ in react?
- Building a React app forces you to 'think in React' by planning out each page view and how to manage state between each page of the app.

- [ ] Describe state.
- Read-only data being held/set to pass dynamic information

- [ ] Describe props.
- Object properties (often as state) that can be assigned to DOM elements and displayed to users

- [ ] What are side effects, and how do you sync effects in a React component to state or prop changes?
- A side effect is anything that changes something outside of the scope of the function.
- You use the useEffect hook, and place the variable you want to watch in the second parameter of the useEffect hook
